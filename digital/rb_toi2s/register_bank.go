...
func main() {
	...
	sys_cfg := []Symbol{
		{0, "mute", "sys_cfg", 0, 1, 0, 0, false, "Mute output", "Long"},
		{1, "mute_l", "sys_cfg", 0, 1, 1, 0, false, "Mute Left", "Long"},
		{2, "mute_r", "sys_cfg", 0, 1, 2, 0, false, "Mute Right", "Long"},
		{10, "debug_led", "sys_cfg", 3, 8, 0, 0x55, false, "Debug led signals", "Debug led signals"},
	}
	...
	bootamp_cfg := []Symbol{
		{0, "bootmem0", "bootamp_cfg", 0, 8, 0, 0x40, false, "Bootmem send to amp on startup", "Long"},
		{1, "bootmem1", "bootamp_cfg", 1, 8, 0, 0x18, false, "Bootmem send to amp on startup", "Long"},
		{2, "bootmem2", "bootamp_cfg", 2, 8, 0, 0x53, false, "Bootmem send to amp on startup", "Long"},
		{3, "bootmem3", "bootamp_cfg", 3, 8, 0, 0x08, false, "Bootmem send to amp on startup", "Long"},
		{4, "bootmem4", "bootamp_cfg", 4, 8, 0, 0xff, false, "Bootmem send to amp on startup", "Long"},
		{5, "bootmem5", "bootamp_cfg", 5, 8, 0, 0xff, false, "Bootmem send to amp on startup", "Long"},
		{6, "bootmem6", "bootamp_cfg", 6, 8, 0, 0xff, false, "Bootmem send to amp on startup", "Long"},
		{7, "bootmem7", "bootamp_cfg", 7, 8, 0, 0xff, false, "Bootmem send to amp on startup", "Long"},
	}

	debug := []Symbol{
		{0, "dummy_bit", "debug", 0, 1, 0, 0, false, "Dummy bit", "Long"},
	}
	sec := []Section{
		//SID, Name, description, parent, offset, size, symbols

		{0, "sys_cfg", "System configuration", nil, 0x00, 8, sys_cfg},
		{1, "bootamp_cfg", "Bootmem of i2c commands to amplifier", nil, 0x10, 16, bootamp_cfg},
		{2, "debug", "Debug module", nil, 0x20, 16, debug},
	}
